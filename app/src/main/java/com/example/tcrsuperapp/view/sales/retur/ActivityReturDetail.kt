...
import kotlinx.android.synthetic.main.sales_activity_retur_detail.*
...
class ActivityReturDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.sales_activity_retur_detail)
    ...
    private fun getData() {
        val fetchData = FetchData(ApiSales.RETUR_DETAIL +
