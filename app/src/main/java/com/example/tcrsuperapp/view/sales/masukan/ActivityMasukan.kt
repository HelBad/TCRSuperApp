package com.example.tcrsuperapp.view.sales.masukan
...
import kotlinx.android.synthetic.main.sales_activity_masukan.*
...
class ActivityMasukan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.sales_activity_masukan)
    ...
    private fun getData() {
        val fetchData1 = FetchData(ApiSales.MASUKAN_COUNT)
        ...
        val fetchData2 = FetchData(ApiSales.PENGGUNA +
    ...
    private fun simpanMasukan() {
        AndroidNetworking.post(ApiSales.MASUKAN_ADD)
