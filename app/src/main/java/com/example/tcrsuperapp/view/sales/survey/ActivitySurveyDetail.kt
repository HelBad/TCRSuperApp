...
import kotlinx.android.synthetic.main.sales_activity_survey_detail.*
import org.json.JSONObject

class ActivitySurveyDetail : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.sales_activity_survey_detail)

        getData()
    }

    private fun getData() {
        val fetchData = FetchData(ApiSales.SURVEY_DETAIL +
