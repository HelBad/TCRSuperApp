...
import kotlinx.android.synthetic.main.staff_activity_sp_list.*
...
class ActivitySpList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.staff_activity_sp_list)
        ...
        tambahList.setOnClickListener {
            startActivity(Intent(this@ActivitySpList, ActivitySp::class.java))
            finish()
        }
    ...
    private fun loadSp() {
        ...
        val fetchData = FetchData(ApiStaff.SP + "?status=" + statusList.text.toString())
    ...
    private fun searchSp() {
        dataArrayList = ArrayList()
        val fetchData = FetchData(ApiStaff.SP + "?perusahaan=" + namaList.text.toString())
        if (fetchData.startFetch()) {
            if (fetchData.onComplete()) {
                val result = fetchData.result
                try {
