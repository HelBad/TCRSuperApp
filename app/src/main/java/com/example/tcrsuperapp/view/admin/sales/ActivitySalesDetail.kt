...
import kotlinx.android.synthetic.main.admin_activity_sales_detail.*
...
class ActivitySalesDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_activity_sales_detail)

        getData()
    }

    private fun getData() {
        val fetchData = FetchData(ApiAdmin.SALES_DETAIL +
