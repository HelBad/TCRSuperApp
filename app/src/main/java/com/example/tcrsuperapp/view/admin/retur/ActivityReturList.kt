...
import kotlinx.android.synthetic.main.admin_activity_retur_list.*
...
class ActivityReturList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_activity_retur_list)
    ...
    private fun loadRetur() {
        ...
        val fetchData = FetchData(ApiAdmin.RETUR + "?status=" + statusList.text.toString())
    ...
    private fun searchRetur() {
        dataArrayList = ArrayList()
        val fetchData = FetchData(ApiAdmin.RETUR + "?perusahaan=" + namaList.text.toString())
        if (fetchData.startFetch()) {
            if (fetchData.onComplete()) {
                val result = fetchData.result
                try {
