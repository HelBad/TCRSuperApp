...
import kotlinx.android.synthetic.main.staff_activity_survey_list.*
...
class ActivitySurveyList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.staff_activity_survey_list)
    ...
    private fun loadSurvey() {
        ...
        val fetchData = FetchData(ApiStaff.SURVEY + "?nama=" + intent.getStringExtra("nama").toString())
