...
import kotlinx.android.synthetic.main.admin_activity_izin.*
...
class ActivityIzin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_activity_izin)
    ...
    private fun getData() {
        val fetchData1 = FetchData(ApiAdmin.IZIN_COUNT)
    ...
    private fun simpanIzin() {
        AndroidNetworking.post(ApiAdmin.IZIN_ADD)
            .addBodyParameter("kode_izin", kode[1])
