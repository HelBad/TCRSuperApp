...
import kotlinx.android.synthetic.main.staff_activity_survey.*
...
class ActivitySurvey : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.staff_activity_survey)
    ...
    private fun getData() {
        val fetchData1 = FetchData(ApiStaff.SURVEY_COUNT)
    ...
    private fun simpanSurvey() {
        AndroidNetworking.post(ApiStaff.SURVEY_ADD)
