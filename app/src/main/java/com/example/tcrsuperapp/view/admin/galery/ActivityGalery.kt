package com.example.tcrsuperapp.view.admin.galery
...
import kotlinx.android.synthetic.main.admin_activity_galery.*
...
class ActivityGalery : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_activity_galery)
    ...
    private fun loadGalery() {
        ...
        val fetchData = FetchData(ApiAdmin.GALERY)
