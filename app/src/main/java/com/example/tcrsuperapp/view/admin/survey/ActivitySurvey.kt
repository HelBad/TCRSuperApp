...
import kotlinx.android.synthetic.main.admin_activity_survey.*
...
class ActivitySurvey : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_activity_survey)
    ...
    private fun getData() {
        val fetchData1 = FetchData(ApiAdmin.SURVEY_COUNT)
    ...
    private fun simpanSurvey() {
        AndroidNetworking.post(ApiAdmin.SURVEY_ADD)
