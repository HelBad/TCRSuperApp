...
import kotlinx.android.synthetic.main.sales_activity_absensi.*
...
class ActivityAbsensi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.sales_activity_absensi)
    ...
    private fun getData() {
        val fetchData1 = FetchData(ApiSales.ABSENSI_COUNT)
    ...
    private fun uploadFoto() {
        val request: StringRequest = object : StringRequest(Method.POST, ApiSales.ABSENSI_ADD, Response.Listener {
