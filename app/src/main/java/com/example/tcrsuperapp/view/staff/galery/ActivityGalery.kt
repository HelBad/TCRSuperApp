package com.example.tcrsuperapp.view.staff.galery
...
import kotlinx.android.synthetic.main.staff_activity_galery.*
...
class ActivityGalery : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.staff_activity_galery)
    ...
    private fun loadGalery() {
        ...
        val fetchData = FetchData(ApiStaff.GALERY)
