...
import kotlinx.android.synthetic.main.admin_activity_sp_detail.*
...
class ActivitySpDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_activity_sp_detail)
    ...
    private fun getData() {
        val fetchData = FetchData(ApiAdmin.SP_DETAIL + "?kode_nota=" + intent.getStringExtra("kode").toString())
